...
class Vocabulary extends BaseController
{
   ...
   {
      $vocabularyTableConents = DB::table('vocabulary')->join('courses', 'vocabulary.course', '=', 'courses.id')->where('courses.id', $courseId)->select('vocabulary.id','vocabulary.kana','vocabulary.kanji','vocabulary.polish')->get();
