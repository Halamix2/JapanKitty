...
class Kanji extends BaseController
{
   ...
   */
   ...
   {
      $kanjiTableConents = DB::table('kanji')->join('courses', 'kanji.course', '=', 'courses.id')->where('courses.id', $courseId)->select('kanji.id', 'kanji.kanji', 'kanji.kunyomi', 'kanji.onyomi', 'kanji.definition')->get();
